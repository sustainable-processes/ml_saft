...
from mlsaft.extras.utils.conformer import RDKitConformerRunner
from mlsaft.extras.utils.molecular_fingerprints import _canonicalize_smiles
from mlsaft.extras.utils.parallel import parallel_runner
from mlsaft.extras.utils.scraping import extract_table_links, get_smiles_dipole_moment
...
def check_atoms(mol, elements):
    for atom in mol.GetAtoms():
        if atom.GetSymbol().upper() not in elements:
            return False
    return True
